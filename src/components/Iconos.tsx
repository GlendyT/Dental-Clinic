...
export const Iconos = () => {
  return (
    <>
      <Link to="https://www.instagram.com/clinicaeyajcomalapagt/">
        <img src={ig} alt="" width={30} height={10} />
      </Link>
      <Link to="https://www.tiktok.com/@clinicaeyaj">
        <img
          src={tk}
          alt=""
          width={30}
